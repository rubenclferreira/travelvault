...
class OriginsControllerTest < ActionController::TestCase
  ...
  test "should create origin" do
    assert_difference('Origin.count') do
      post :create, origin: { airline: @origin.airline, date: @origin.date, departure: @origin.departure, location: @origin.location }
    end
  ...
  test "should update origin" do
    patch :update, id: @origin, origin: { airline: @origin.airline, date: @origin.date, departure: @origin.departure, location: @origin.location }
    assert_redirected_to origin_path(assigns(:origin))
  end
